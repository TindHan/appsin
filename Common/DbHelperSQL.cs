...
namespace DBUtility
{
    /// <summary>
    /// 数据访问抽象基础类
    /// Copyright (C) 2018-2025 By Tind 
    /// </summary>
    public abstract class DbHelperSQL
    {

        //数据库连接字符串(appsetting.json来配置)，可以更改connectString支持多数据库.		
        public static string connectionString = (new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory())
            .AddJsonFile("appsettings.json", optional: true, reloadOnChange: true)
            .AddEnvironmentVariables().Build())["syssetting:connectString"];     		
        public DbHelperSQL()
        {            
        }
