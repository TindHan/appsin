...
namespace appsin.Bizcs.DAL
{
    public class sys_menuRole
    {
        ...
        public int Add(Bizcs.Model.sys_menuRole model)
        {
            ...
            strSql.Append("insert into sys_menuRole(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update sys_menuRole set ");
        ...
        public bool Delete(int roleID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from sys_menuRole ");
            strSql.Append(" where roleID=@roleID");
            SqlParameter[] parameters = {
                    new SqlParameter("@roleID", SqlDbType.Int,4)
            };
        ...
        public Bizcs.Model.sys_menuRole GetModel(int roleID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 roleID,rolePK,roleName,roleType,roleMemo1,roleMemo2,roleMemo3,roleMemo4,roleMemo5,displayOrder,createTime,createUser,roleStatus from sys_menuRole ");
            strSql.Append(" where roleID=@roleID");
            SqlParameter[] parameters = {
                    new SqlParameter("@roleID", SqlDbType.Int,4)
            };
            ...
            Bizcs.Model.sys_menuRole model = new Bizcs.Model.sys_menuRole();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Bizcs.Model.sys_menuRole DataRowToModel(DataRow row)
        {
            Bizcs.Model.sys_menuRole model = new Bizcs.Model.sys_menuRole();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parms)
        {
            ...
            strSql.Append(" FROM sys_menuRole ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parms)
        {
            ...
            strSql.Append(")AS Row, T.*  from sys_menuRole T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT  roleID as objID,roleName as objName,'menu' as objType,'' as objDesc, '' as objCode,'' as objParent from sys_menuRole where roleStatus=1");
            strSql.Append(" union ");
            strSql.Append("SELECT  roleID as objID,roleName as objName,'data' as objType,'' as objDesc, '' as objCode,'' as objParent from sys_dataRole where roleStatus=1");
