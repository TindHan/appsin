...
namespace appsin.Bizcs.DAL
{
    public class app_noticeRead
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(appsin.Bizcs.Model.app_noticeRead model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into app_noticeRead(");
            strSql.Append("noticeID,psnID,readTime,readDesc,readStatus)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(appsin.Bizcs.Model.app_noticeRead model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update app_noticeRead set ");
        ...
        public bool Delete(int readID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from app_noticeRead ");
            strSql.Append(" where readID=@readID");
            SqlParameter[] parameters = {
                    new SqlParameter("@readID", SqlDbType.Int,4)
            };
        ...
        /// 得到一个对象实体
        /// </summary>
        public appsin.Bizcs.Model.app_noticeRead GetModel(int readID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 readID,noticeID,psnID,readTime,readDesc,readStatus from app_noticeRead ");
            strSql.Append(" where readID=@readID");
            SqlParameter[] parameters = {
                    new SqlParameter("@readID", SqlDbType.Int,4)
            };
            ...
            appsin.Bizcs.Model.app_noticeRead model = new appsin.Bizcs.Model.app_noticeRead();
        ...
        /// 得到一个对象实体
        /// </summary>
        public appsin.Bizcs.Model.app_noticeRead DataRowToModel(DataRow row)
        {
            appsin.Bizcs.Model.app_noticeRead model = new appsin.Bizcs.Model.app_noticeRead();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select readID,noticeID,psnID,readTime,readDesc,readStatus ");
            strSql.Append(" FROM app_noticeRead ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parms)
        {
            ...
            strSql.Append(")AS Row, T.*  from app_noticeRead T ");
