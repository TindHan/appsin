...
namespace appsin.Bizcs.BLL
{
    ...
    {
        private readonly Bizcs.DAL.sys_fieldset dal = new Bizcs.DAL.sys_fieldset();
        public sys_fieldset()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bizcs.Model.sys_fieldset> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bizcs.Model.sys_fieldset> DataTableToList(DataTable dt)
        {
            List<Bizcs.Model.sys_fieldset> modelList = new List<Bizcs.Model.sys_fieldset>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Bizcs.Model.sys_fieldset model;
