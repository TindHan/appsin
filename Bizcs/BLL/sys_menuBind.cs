...
namespace appsin.Bizcs.BLL
{
    ...
    {
        private readonly Bizcs.DAL.sys_menuBind dal = new Bizcs.DAL.sys_menuBind();
        public sys_menuBind()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bizcs.Model.sys_menuBind> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Bizcs.Model.sys_menuBind> DataTableToList(DataTable dt)
        {
            List<Bizcs.Model.sys_menuBind> modelList = new List<Bizcs.Model.sys_menuBind>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Bizcs.Model.sys_menuBind model;
