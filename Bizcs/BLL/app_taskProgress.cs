...
namespace appsin.Bizcs.BLL
{
    ...
    {
        private readonly appsin.Bizcs.DAL.app_taskProgress dal = new appsin.Bizcs.DAL.app_taskProgress();
        ...
        public appsin.Bizcs.Model.app_taskProgress GetModel(int progressID)
        {
            ...
            return dal.GetModel(progressID);
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<appsin.Bizcs.Model.app_taskProgress> GetModelList(string strWhere, params SqlParameter[] parms)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<appsin.Bizcs.Model.app_taskProgress> DataTableToList(DataTable dt)
        {
            List<appsin.Bizcs.Model.app_taskProgress> modelList = new List<appsin.Bizcs.Model.app_taskProgress>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                appsin.Bizcs.Model.app_taskProgress model;
