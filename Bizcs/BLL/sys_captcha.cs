...
namespace appsin.Bizcs.BLL
{
    ...
    {
        private readonly appsin.Bizcs.DAL.sys_captcha dal = new appsin.Bizcs.DAL.sys_captcha();
        public sys_captcha()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<appsin.Bizcs.Model.sys_captcha> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<appsin.Bizcs.Model.sys_captcha> DataTableToList(DataTable dt)
        {
            List<appsin.Bizcs.Model.sys_captcha> modelList = new List<appsin.Bizcs.Model.sys_captcha>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                appsin.Bizcs.Model.sys_captcha model;
        ...
        {
            return dal.GetValidModel(captchaStr);
        }
